...
namespace RE {
    ...
    struct NiMatrix3 {
        ...
        void ToEulerAnglesXYZ(NiPoint3& outAngles) const {
            // Simplified euler extraction for testing
            // In real code, this does proper matrix decomposition
            outAngles.x = 0.0f;
            outAngles.y = 0.0f;
            outAngles.z = 0.0f;
        }
    ...
    public:
        ...
        static T* LookupByID(FormID id) {
            // Stub for testing - returns nullptr
            return nullptr;
        }
        ...
        static TESForm* LookupByEditorID(const std::string& editorID) {
            return nullptr;
        }
    };
    ...
    public:
        ...
        void SetAngle(const NiPoint3& ang) { angle = ang; }
        float GetScale() const { return scale; }
        void SetScale(float s) { scale = s; }
        const char* GetDisplayFullName() const { return displayName.c_str(); }
        void SetDelete(bool del) { deleted = del; }
        TESObjectCELL* GetParentCell() const { return parentCell; }
        void SetParentCell(TESObjectCELL* cell) { parentCell = cell; }
    ...
    class TESModel {
    public:
        virtual const char* GetModel() const { return modelPath.c_str(); }
    ...
    inline const char* FormTypeToString(FormType type) {
        switch (type) {
    ...
    inline FormType GetFormType() { return FormType::None; }
